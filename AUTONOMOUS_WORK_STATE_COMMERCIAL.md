...
- Следующее по ПОРЯДКУ: B3 обновления (updater.rs + content_updater.rs: публикация→манифест→доставка→установка→откат на битом манифесте; метод-инвариант aurora_contentpack_dualsource_runtime).
