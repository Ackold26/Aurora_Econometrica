...
- Следующее: A3 = OPP-05 (preflight-гейт ДО кнопки «Обучить»: Rust econ_preflight + UI баннер в ModelTrainingStep) + OPP-03 (единый язык тиров на forward-оптимизации и compare-странице) + OPP-08 (forecast-scaling подключить или снести).
