...
- Остаток B1: HTML-отчёт тем же зондом (aurora_html — общий адаптер уже честен; проверить билдер-слой на свои wireframe-дефолты) → xlsx-экспорт → scenario-export.js. Потом A3.
