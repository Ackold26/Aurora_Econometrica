...
.idx .idx-title {{ font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; color: var(--text3); margin: 0 0 10px; padding-bottom: 0; border-bottom: none; }}
...
.term .lbl {{ display: block; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; margin-bottom: 4px; }}
...
<div class="idx">
  <h2 class="idx-title">Алфавитный указатель</h2>
  <ul>
{index_html}
  </ul>
</div>
