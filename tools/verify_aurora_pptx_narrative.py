...
def main() -> int:
    ...
    res, xml = _build({}, {}, {})
    results.append(_check("Case 1 (default): 12 slides", res.get("slides") == 12))
    ...
    results.append(_check("Case 2 (kagocel-like): 12 slides", res.get("slides") == 12))
    ...
    results.append(_check("Case 3 (3-ch min): 12 slides", res.get("slides") == 12))
    ...
    results.append(_check("Case 4 (10-ch max): 12 slides", res.get("slides") == 12))
    ...
    results.append(_check("Case 5 (empty-ch fallback): 12 slides", res.get("slides") == 12))
    ...
    results.append(_check("Case 6 (partial diag): 12 slides",
                          res.get("slides") == 12))
    ...
    results.append(_check("Case 7 (no-TV): 12 slides", res.get("slides") == 12))
