...
- **2026-06-20 (6) Имя ассистента → «Аврора»** (идея Антона) — «Спросить ИИ» → «Спросить Аврору»: заголовок-лицо в панели, подсказка поля, самопрезентация в промпте (TIER2_SYSTEM_RULES). svelte-check 0, тесты 12/12. Дальше — live E2E (Антон: «делаем»).
