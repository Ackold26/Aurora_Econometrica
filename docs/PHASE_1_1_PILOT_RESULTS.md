...
```
  ...
  per-channel:
    ch0: true=0.45 posterior_mean=0.29 HDI=[0.00,0.56]
    ch1: true=0.40 posterior_mean=0.23 HDI=[0.00,0.57]
    ch2: true=0.10 posterior_mean=0.07 HDI=[0.00,0.17]
    ch3: true=0.08 posterior_mean=0.04 HDI=[0.00,0.11]
...
```
  ...
  per-channel:
    ch0: true=0.45 posterior_mean=0.22 HDI=[0.01,0.49]
    ch1: true=0.40 posterior_mean=0.19 HDI=[0.00,0.39]
    ch2: true=0.10 posterior_mean=0.10 HDI=[0.00,0.20]
    ch3: true=0.08 posterior_mean=0.08 HDI=[0.00,0.15]
    ch4: true=0.05 posterior_mean=0.12 HDI=[0.01,0.24]
```

## Verdict

- Recovery: Beta-Beta 100%, logit-normal 80%
- Divergences: Beta-Beta 1, logit-normal 1
- Time ratio (LN/BB): 0.65×
