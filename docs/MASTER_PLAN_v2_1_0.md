...
✅ **Партия 2 (безопасность pickle) — закрыта целиком**
✅ **Партия 3 (премиум-доводка) — все 7 пунктов**
✅ **Партия 4 (документация) — 5/6 пунктов** (6.6 ждёт Антона)
✅ **Партия 5 (сборка) — инфраструктура** (финальная сборка после ack)
✅ **Партия 1 п.1.2** (пилотный сценарий)
✅ **Пилот выполнен 2026-05-16** — 21 находка → `docs/PILOT_FINDINGS_CONSOLIDATED.md`
✅ **RC2 цикл доработок завершён** (9/9 P0+P1+P2 closed) — `docs/RC2_IMPLEMENTATION_REPORT.md`

🔄 **В работе:**
- Red-team аудит RC2 правок (sub-agent)
- Шаг 6 (доработка по аудиту) — ждёт результатов
...
| 9.8 | Установка в чистом окружении | 6 | 🟢 готов к запуску — Windows Sandbox (встроен в Win 11 Pro, runbook обновлён) |
