...
## v2.0.1-rc2 ✅ COMPLETE — v2.1.0 цикл утверждён (2026-05-15 ночь)

**Sprint статус:** все 5 партий done, 34 commit pushed (HEAD `b87aa68`), 947 тестов passing, реальная зрелость 78%.

**Следующий цикл v2.1.0** утверждён Антоном через анкету по приоритетам — детально в `docs/v2_1_0_plan.md`.

**Краткий план (~95-100ч, 3-4 недели):**
1. Партия 1 — Пилот целиком (1.1+1.2+1.3), ~10-15ч
2. Партия 2 — Безопасность 4.1 (замена устаревшего pickle на безопасный формат), ~15ч
3. Партия 3 — Премиум-доводка интерфейса (этап 5 целиком), ~30ч
4. Партия 4 — Документация и обучение (этап 6 целиком), ~25ч
5. Партия 5 — Сборка установщика Windows (9.1+9.4+9.6+9.8), ~15ч

**Прогноз:** 78% → 94%. Готов к прямым продажам 50-100 клиентам на русском под Windows.

**Старт:** следующая сессия (Антон 2026-05-15 решил отложить).

**Backlog (3-6 мес отложено):** `docs/v2_2_0_backlog.md` — английский язык, расширенная безопасность, многопользовательский, кросс-продукт, macOS/Linux/Store, метрики, полная замена pickle.
