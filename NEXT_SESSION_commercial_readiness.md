...
# После волн — план развития v3.0 (утверждён Антоном 2026-07-03)

Этот файл — **Фаза 0 (входной билет)**. Дальнейшее развитие — **`docs/ROADMAP_v3_IDEAL_PRODUCT.md`**:
хребет «петля доверия» (E1 backtest-витрина ⭐ → E3 жизненный цикл модели → E2 калибровка
lift-тестами + E4 рекомендации-обещания; сквозная E5 время-до-инсайта ≤30 мин; анти-фокус:
geo-MMM/DL/causal). Закончив волны — переходить к E1 без отдельной команды (утверждено).
