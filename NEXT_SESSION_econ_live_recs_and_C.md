...
- ✅ **insights-rules.js шире — ВЫПОЛНЕНО (2026-07-05):** 6 голых функций закрыты
  прямыми юнитами — `insights-uncovered-functions.test.js` (50 тестов; субагент
  sonnet по мандату, моя приёмка: ревью + 2 мутации кусаются + прогон). vitest
  полный 925. Остальные 5 функций покрыты ранее (validate 13 / model 10 /
  optimize+decompose+report по 4, узко) — расширение их глубины по желанию.
