...
3. 🟠 **Демо-файлы неудачные:** дополнить sample-файлы (static/sample-data: synth_fmcg_brand и 1-2 других) хвостом-медиапланом (6-12 будущих месяцев, инвестиции заполнены, KPI пуст) — чтобы клиентский демо-путь сразу показывал Планирование. Пересобрать и на Desktop.
