...
CONTROL_PATTERNS = ['search', 'queries', 'competitor', 'distribution',
                    ...
                    # 14.09.2026: ПОЛНОЕ русское название ИПЦ не распознавалось
                    # вовсе — клиент, назвавший столбец по-человечески, получал
                    # «неизвестная колонка». Коротких форм ('ипц', 'cpi') мало.
                    'потребительских_цен', 'потребительских цен', 'потребительских-цен',
                    'gdp', 'ввп', 'gdp_growth',
                    ...
                    # 14.09.2026 (владелец): юань и ключевая ставка. Голые
                    # 'cny'/'ставка' НЕ добавлять по той же причине, что и голое
                    # 'курс': 'cny' — суффикс валюты у медийных бюджетов, «ставка»
                    # живёт в «ставка НДС» и «ставка за показ».
                    'cny_rub', 'cny rub', 'cny-rub',
                    'курс_юаня', 'курс юаня', 'курс-юаня',
                    'ключевая_ставка', 'ключевая ставка', 'ключевая-ставка',
                    'ставка_цб', 'ставка цб', 'ставка-цб',
