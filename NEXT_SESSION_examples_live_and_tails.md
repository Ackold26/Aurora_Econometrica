...
> Известное движковое (НЕ чинилось, вне скоупа): авто-праздники дневных окон на
> месячной грануляции флаки/нулевые (auto-BF 2/4 ноябрей ловится датой конца месяца;
> дедуп с ручной колонкой по имени не срабатывает: `holiday_black_friday` ≠
> `holiday_blackfriday`) — кандидат в задачу движка.
