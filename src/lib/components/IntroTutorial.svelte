<script>
  ...
  const slides = [
    ...
    },
    {
      ...
      body: 'Aurora работает с разными KPI: выручка (₽), продажи в штуках, лиды, регистрации, подписки и т.д. На старте выбираете режим одним кликом: ROI (все каналы в ₽) или Эффективность (все в физических метриках). Для опытных аналитиков в Expert mode доступен смешанный режим - поканальный выбор единиц.',
    },
  ];
