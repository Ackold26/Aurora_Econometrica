    ...
    <div class="card">
      ...
      <div class="body">
        ...
        <p>
          ...
          передаётся во внешний облачный сервис обработки и возвращается ответ. Это
        ...
        {#if showFull}
          <div class="terms">
            <p>
              ...
              показатели, рекомендации) – во внешний облачный сервис обработки (за пределами РФ) для
      ...
      <label class="consent-check">
        ...
        <span>
          ...
          трансграничную передачу данных, при использовании кабинетов-советников.
        </span>
      </label>
