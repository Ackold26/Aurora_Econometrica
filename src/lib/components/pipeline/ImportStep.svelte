        ...
        <div class="engine-cards">
          ...
          >
            ...
            <p class="engine-card-desc">
              Золотой стандарт MMM-эконометрики. NUTS-сэмплер (NumPyro) оценивает полное апостериорное распределение для параметров каждого канала: корректные правдоподобные диапазоны ROI и mROAS, устойчивость к выбросам, калиброванная неопределённость. Для решений с финансовыми последствиями.
            </p>
          ...
          >
            ...
            <p class="engine-card-desc">
              Small-data fallback. OLS-регрессия с аналитическим решением и bootstrap-правдоподобными диапазонами (частотный подход): численно стабильное решение ценой статистической мощности. Для пилотных проектов и предварительного анализа - рекомендации трактовать как направление, а не точное число.
            </p>
          </button>
        </div>
      </div>
