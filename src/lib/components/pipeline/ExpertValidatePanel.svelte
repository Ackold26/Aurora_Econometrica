      ...
      <table class="stats-table">
        <thead>
          <tr>
            ...
            <th>
              Пропуски %
              <span class="help-icon" title="Доля строк с пропущенным значением (NaN). Для медиа и факторов при обучении пропуски считаются нулём, то есть «активности не было». Для целевой метрики (KPI) пропуск исключает период из обучения целиком – вместе с медиа-данными этой недели. При &gt;20% столбец лучше исключить.">?</span>
            </th>
            <th>
              Нули %
