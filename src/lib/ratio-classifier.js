...
export function classifyRatio(ratio) {
  ...
  if (ratio < RATIO_THRESHOLDS.IDEAL) {
    return {
      ...
      description: 'Достаточный объём данных. Для ещё более узких доверительных интервалов нужно ≥6:1',
      tone: 'info',
  ...
  return {
    ...
    description: 'Узкие доверительные интервалы — оптимальный объём наблюдений на переменную',
    tone: 'success',
